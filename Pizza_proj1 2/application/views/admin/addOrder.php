        ...
        <div class="row">
         ...
         <div class="row">
            ...
            <div class="col-lg-4 col-lg-offset-2">
                ...
                <button class="btn btn-default btn-warning btn-block" type="reset"><i class="fa fa-repeat"></i>&nbsp;&nbsp;RESET</button>
                    
                </div>
                
                    <div class="col-lg-4">
                        <button type="submit" class="btn btn-default btn-primary btn-block" name="order" id="order"><i class="fa fa-shopping-basket"></i>&nbsp;&nbsp;ORDER</button>
                    </div>
        ...
        if(pd==0){
            ...
            if(topping==null || crustType==0){
               ...
               $.ajax({
                    ...
                    url:"http://localhost:8081/pizza_proj1/index.php/admin/process" ,
                    data:data,
                    type:"POST",
